...
public class SearchSort {
	// explained in readme. one solution uses a boolean to check if a swap has
	// been completed or not.
	// This does not have to be recursive. Otherwise this method is explained in
	// the readme.
	...
	// takes a sorted array and returns the index of the desired string or -1 if
	// not found
	...
	private static int binarySearchHelper(String[] arr, int lo, int hi, String lookfor) {
		// this should be done recursively. Assume that the passed in array is
		// sorted. Look at the
		// midpoint of the array and see if the string "lookfor" comes before or
		// after the midpoint.
		// Then recursively call binarySearchHelper with the part of the array
		// that you think holds "lookfor"
		// What are your base cases? Handle the case where the string is not
		// found.
		// Part of the trick here is you will be maintaining the original array.
		// You are just moving the pointers "lo" and "hi"
		// so that the function looks at a specific part of the array. This way
		// you will be able to return the index of "lookfor".
		return null;
	}
	...
	private static String[] merge(String[] a, String[] b) {
		// takes two sorted string arrays and makes them one sorted string
		// array.
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		// Use binarySearch to search for Luke Skywalker, I found him at index
		// 16.
